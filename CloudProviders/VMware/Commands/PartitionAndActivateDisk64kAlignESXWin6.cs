...
{
  public class PartitionAndActivateDisk64kAlignESXWin6 : JobCommand, IJobCommandVolumeInfo
  {
    public PartitionAndActivateDisk64kAlignESXWin6(JobContext context)
      : base(context)
    {
    }
